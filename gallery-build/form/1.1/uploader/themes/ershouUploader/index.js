 ...
 **/
KISSY.add('gallery/form/1.1/uploader/themes/ershouUploader/index', function (S, Node, Theme, Message, SetMainPic) {
    var EMPTY = '', 
    	$ = Node.all,
    ...
    S.extend(ErshouUploader, Theme, /** @lends ErshouUploader.prototype*/ {
    	...
    	ATTRS: /** @lends ErshouUploader.prototype*/ {
	         ...
	         */
	        cssUrl: { 
	        	value: 'gallery/form/1.1/uploader/themes/ershouUploader/style.css'
			},
	        /**
	         * 队列使用的模板
	         * @type String
 ...
 * @date 2012-01-11
 */
KISSY.add('gallery/form/1.1/uploader/themes/ershouUploader/message', function(S, Node){
 ...
 * @requires KISSY 1.2+
 */
KISSY.add('gallery/form/1.1/uploader/themes/ershouUploader/setMainPic', function(S, Node){
