 ...
 **/
KISSY.add('gallery/form/1.2/uploader/auth/base', function (S, Node,Base) {
    var EMPTY = '', $ = Node.all,
 ...
 **/
KISSY.add('gallery/form/1.2/uploader/button/base',function(S, Node, Base) {
    var EMPTY = '',
 ...
 * @author: 紫英(橘子)<daxingplay@gmail.com>, 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('gallery/form/1.2/uploader/button/swfButton', function (S, Node, Base, SwfUploader) {
    var EMPTY = '', $ = Node.all,
    ...
    S.extend(SwfButton, Base, /** @lends SwfButton.prototype*/{
         ...
         * @type Object
         * @default { src:'http://a.tbcdn.cn/s/kissy/gallery/form/1.2/uploader/plugins/ajbridge/uploader.swf', id:'swfUploader', params:{ bgcolor:"#fff", wmode:"transparent" }, attrs:{ }, hand:true, btn:true }
             }
         */
        flash:{
            value:{
 ...
 */
KISSY.add('gallery/form/1.2/uploader/plugins/ajbridge/ajbridge', function(S,Flash) {
 ...
 * @author kingfo  oicuicu@gmail.com
 */
KISSY.add('gallery/form/1.2/uploader/plugins/ajbridge/uploader', function(S,flash,A) {
 ...
 *  @author 飞绿
 */
KISSY.add('gallery/form/1.2/uploader/plugins/filedrop/filedrop', function (S, Node, Base) {
    var EMPTY = '',
        $ = Node.all,
        UA = S.UA;
    /**
...
KISSY.add('gallery/form/1.2/uploader/plugins/preview/preview', function(S, D, E){
	var doc = document, 
 ...
 * @author 剑平（明河）<minghe36@126.com>
 **/
KISSY.add('gallery/form/1.2/uploader/plugins/progressBar/progressBar',function(S, Node, Base) {
    var EMPTY = '',$ = Node.all,
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('gallery/form/1.2/uploader/queue', function (S, Node, Base) {
     ...
     * @example
     * S.use('gallery/form/1.2/uploader/queue/base,gallery/form/1.2/uploader/themes/default/style.css', function (S, Queue) {
     *    var queue = new Queue();
     *    queue.render();
     * })
     */
...
KISSY.add('gallery/form/1.2/uploader/theme', function (S, Node, Base) {
    var EMPTY = '', $ = Node.all,
        //主题样式名前缀
    ...
    S.extend(Theme, Base, /** @lends Theme.prototype*/{
        ...
        _loadPlugins:function(callback){
            var self = this,
                ...
                //模块路径前缀
                modPrefix = 'gallery/form/1.2/uploader/plugins/',
                mods = [];
            if(!plugins.length){
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('gallery/form/1.2/uploader/type/ajax',function(S, Node, UploadType) {
 ...
 * @author: 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('gallery/form/1.2/uploader/type/base',function(S, Node, Base) {
    var EMPTY = '',$ = Node.all;
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('gallery/form/1.2/uploader/type/flash', function (S, Node, UploadType, swfUploader) {
 ...
 * @author 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('gallery/form/1.2/uploader/type/iframe',function(S, Node, UploadType) {
 ...
 * @author: 剑平（明河）<minghe36@126.com>,紫英<daxingplay@gmail.com>
 **/
KISSY.add('gallery/form/1.2/uploader/urlsInput',function(S, Node, Base) {
