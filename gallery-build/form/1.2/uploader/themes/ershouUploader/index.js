 ...
 * @date 2012-01-11
 */
KISSY.add('gallery/form/1.2/uploader/themes/ershouUploader/message', function(S, Node){
 ...
 * @requires KISSY 1.2+
 */
KISSY.add('gallery/form/1.2/uploader/themes/ershouUploader/setMainPic', function(S, Node){
