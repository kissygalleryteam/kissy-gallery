...
return S.TripCalendar = S.extend(Calendar, S.Base, {
    ...
    initializer: function() {
        ...
        this._clickoutside = function(e) {var target = S.one(e.target); target.hasClass(this._triggerNodeClassName) || target.hasClass(this._triggerNodeIcon) || target.parent('#' + this._calendarId) || this.hide();};
        ...
        (function(that, currentNode) {
            ...
            setTimeout(function() {
                var iLeft              = currentNode.offset().left,
                    ...
                    iMaxLeft           = D.docWidth() * 1 - iBoundingBoxWidth,
                    iMaxTop            = D.docHeight() * 1 - iBoundingBoxHeight;
                (function(t, l) {
    ...
    _DELEGATE: {
        ...
        'iconClick': function(e) {
            var target      = S.one(e.target).parent('.calendar-input-wrap').one('.' + this._triggerNodeClassName),
                ...
                currentNode = this.currentNode ? this.currentNode.getDOMNode() : null;
    ...
    _createSelect: function() {
        var curDate  = this.get('date'),
            ...
            curMonth = Calendar.DATE.filled(curDate.getMonth() * 1 + 1),
...
}, {requires:['node', 'base', 'sizzle', 'gallery/calendar/1.0/assets/index.css']});